...
void test_ht_insert() {
  ...
  *v3 = 3;
  ...
  EXPECT_EQ("Insert into already exists, returns 0", 0, ht_insert(&table, strdup("Hello"), v3));
  EXPECT_EQ("Insert into already exists, value is 3", *v3, *(int*)ht_find(&table, "Hello"));
